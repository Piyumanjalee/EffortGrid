...
function Footer() {
  return (
    <footer className="relative z-10 mt-auto border-t border-white/30 bg-white/80 text-slate-600 shadow-xl backdrop-blur-xl">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6 py-6 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2">
            <p className="text-lg font-semibold text-slate-900">EffortGrid</p>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 self-start rounded-md bg-sky-500 px-5 py-2 text-xs font-semibold uppercase tracking-[0.08em] text-white transition hover:bg-sky-600"
          >
            Contact and Profile
        ...
        <div className="flex flex-col items-start justify-between gap-4 border-t border-white/30 py-4 text-sm text-slate-600 md:flex-row md:items-center">
